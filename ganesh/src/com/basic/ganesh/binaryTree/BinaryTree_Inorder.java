...
public class BinaryTree_Inorder {
	...
	public CharNode buildTree(char in[], char pre[], int inStrt, int inEnd) 
	{
		if (inStrt > inEnd) 
			return null;
		...
		CharNode tNode = new CharNode(pre[preIndex++]);
	...
	public void printInorder(CharNode node) 
	{
		if (node == null)
			return;
	...
	public static void main(String args[]) 
	{
		...
		int len = in.length;
		CharNode root = tree.buildTree(in, pre, 0, len - 1);
