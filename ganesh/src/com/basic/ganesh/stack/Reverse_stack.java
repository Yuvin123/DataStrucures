package com.basic.ganesh.stack;
...
public class Reverse_stack {
	...
	static void insert_at_bottom(char x) {
		...
		if (st.isEmpty())
			...
			/*
			 * All items are held in Function Call Stack until we reach end of
			 * the stack. When the stack becomes empty, the st.size() becomes 0,
			 * the above if part is executed and the item is inserted at the
			 * bottom
			 */
